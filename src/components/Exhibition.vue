<template>
  <div class="exhibition-component">
    <el-container v-loading="table_loading">
      ...
      <el-main>
        ...
        >
          ...
          <el-table-column label="展览ID" prop="id" width="120" :sortable="true"></el-table-column>
          <el-table-column label="展览名称" prop="name" width="300" :sortable="true"></el-table-column>
          <el-table-column label="展览时间" prop="time" width="300" :sortable="true">
            <template slot-scope="props">
        ...
        <el-carousel type="card" height="400px" @change="switchImage">
          ...
          <el-carousel-item>
            <el-upload
              ...
              :multiple="true"
              :data="{exhibition_id:image_dialog.exhibition_id}"
...
export default {
  ...
  methods: {
    ...
    get_exhibtion() {
      ...
      let baseurl = "/api/web/get_exhibition?";
      ...
      vm.$http
        ...
        .then(res => {
          if (res.data.status == 1) {
            vm.exhibition_list = res.data.data.exhibition_list;
            vm.$message({
              message: res.data.data.msg,
              center: true
            });
    ...
    toImageDialog(row) {
      ...
      vm.image_dialog.exhibition_id = row.id;
...
<style >
.exhibition-component .form-line-box {
  text-align: center;
  padding-top: 10px;
}
.exhibition-component .form-line-box .el-form-item {
  padding: 10px;
}
.exhibition-component .page-box {
  text-align: center;
}

.exhibition-component .avatar-uploader .el-upload {
...
.exhibition-component .avatar-uploader .el-upload:hover {
  border-color: #409eff;
}
.exhibition-component .avatar-uploader-icon {
  font-size: 50px;
  color: black;
  width: 400px;
  height: 400px;
